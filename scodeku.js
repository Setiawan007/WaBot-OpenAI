...
module.exports = scodeku = async (client, m, chatUpdate, store) => {
    try {
    ...
    if (setting.autoAI) {
        if (budy) {
            try {
            if (setting.keyopenai === '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') return reply('Apikey belum diisi\n\nSilahkan isi terlebih dahulu apikeynya di file key.json\n\nApikeynya bisa dibuat di website: https://beta.openai.com/account/api-keys')
